<?php
    ...
    class Song {
        ...
        public function getRelatedSongs(){
            $query = mysqli_query($this->con, "SELECT * from track_plays t join songs s on s.id = t.songid where s.genre = '$this->genre' AND id != '$this->id' ORDER BY `t`.`total_plays` DESC  LIMIT 14 ");
            $array = array();
